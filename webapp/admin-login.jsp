...
<body>
	...
	<div id="login-page">
		<div class="container">
			...
			<form action="AdminController" method="post" class="form-login">
				<h2 class="form-login-heading">sign in now</h2>
				<div class="login-wrap">
					<input type="email" class="form-control" name="email" placeholder="User Email" autofocus> <br> 
					<input type="password" class="form-control" name="password" placeholder="User Password"> 
					<button class="btn btn-theme btn-block" name="action" value="login" href="index.html"
						type="submit">
