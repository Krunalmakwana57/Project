		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<li class="mt"><a class="active" href="admin-home.jsp"> <i
							class="fa fa-dashboard"></i> <span>Dashboard</span>
					</a></li>

					<li class="sub-menu"><a href="admin-serviceman-list.jsp"> <i
							class="fa fa-desktop"></i> <span>ServiceMan</span>
					</a></li>

					<li class="sub-menu"><a href="admin-customer-list.jsp"> <i
							class="fa fa-cogs"></i> <span>Customers</span>
					</a></li>
					<li class="sub-menu"><a href="admin-services-list.jsp"> <i
							class="fa fa-book"></i> <span>Services</span>
					</a>
						<ul class="sub">
							<li><a href="blank.html">Book Services</a></li>
						</ul></li>
				</ul>
				<!-- sidebar menu end-->
			</div>
