	...
	<div class="container">
		<div class="col-lg-12">
			<table class="table">
				...
				<tbody>
					<%
					List<BookService> list = BookDao.getCompleteServiceByCustomerId(s.getId());
					%>
					<%
					...
					<tr>
						...
						<td>
							<form method="post" action="payment.jsp?amount=<%=service.getSprice()%>">
								<table border="1">
									<tbody>
										<tr>
											<th>S.No</th>
										...
										<tr>
											...
											<td><input title="TXN_AMOUNT" tabindex="10" type="text"
												name="TXN_AMOUNT" value="<%=service.getSprice()%>"></td>
										</tr>
										<tr>
											<td></td>
											<td></td>
