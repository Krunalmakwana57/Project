    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="text-primary text-uppercase">// Customer Login //</h6>
                <h1 class="mb-5">Customer Login</h1>
            </div>
            <div class="row g-4">
                <div class="col-md-12">
                    <div class="wow fadeInUp" data-wow-delay="0.2s">
                        <form action="CustomerController" method="post">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-primary w-100 py-3" type="submit" name="action" value="login">Login</button>
                                </div>
                            </div>
                        </form>
                    </div>
